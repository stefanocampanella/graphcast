...
class Predictor(abc.ABC):
  ...
  def model_config(self):
    ...
    elif hasattr(self, "_predictor"):
      return self._predictor.model_config
    else:
      raise NotImplementedError
  ...
  def task_config(self):
    if hasattr(self, "_task_config"):
      ...
      return self._predictor.task_config
    else:
      raise NotImplementedError

  @property
  def mesh_data(self):
    if hasattr(self, "_mesh_data"):
      return self._mesh_data
    elif hasattr(self, "_predictor"):
      return self._predictor.mesh_data
    else:
      raise NotImplementedError

  @property
  def grid_lat(self):
    if hasattr(self, "_grid_lat"):
      return self._grid_lat
    elif hasattr(self, "_predictor"):
      return self._predictor.grid_lat
    else:
      raise NotImplementedError

  @property
  def grid_lon(self):
    if hasattr(self, "_grid_lon"):
      return self._grid_lon
    elif hasattr(self, "_predictor"):
      return self._predictor.grid_lon
    else:
      raise NotImplementedError

  @property
  def grid_mask(self):
    if hasattr(self, "_grid_mask"):
      return self._grid_mask
    elif hasattr(self, "_predictor"):
      return self._predictor.grid_mask
    else:
      raise NotImplementedError